...
const DEFAULTS={selectedStacks:[],stackMode:'any',customTerms:'',excludedTerms:'',downloadFiles:true,sendRadar:false,downloadFolder:'RadarCarreira',portalUrl:'https://radar-carreira-almir-v2.prof-andreiamr.chatgpt.site/api/collector/import',portalToken:''};
